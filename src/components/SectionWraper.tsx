  ...
  return (
    <section id={id} className="min-h-screen flex flex-col gap-10">
        <div className='bg-scheme1-600 py-10 flex flex-col gap-2 justify-center items-center p-4'>
            <p>{header}</p>
            <h2 className='font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6xl'><span>{title[0]}</span> <span className='uppercase text-scheme1-700'>{title[1]}</span> <span>{title[2]}</span></h2>
